<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\demo\zqrb-server-php\public/../application/admin\view\roles\index.html";i:1535952502;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    $("#postform").click(function(){
        ...
        var id = $("#nodeid").val();
        //写入库
        $.post('./giveAccess', {'type' : 'give', 'id' : id, 'access_ids' : NodeString}, function(res){
            layer.close(index);
            if(res.code == 1){
