<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\demo\zq\zqrb-server-php\public/../application/admin\view\index.html";i:1535952501;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
    <!--左侧导航开始-->
    <nav class="navbar-default navbar-static-side" role="navigation" style="background: #ffffff;border-right: 1px solid #6CBBF2;box-shadow: 3px 6px 15px #6cbbf2;">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="__IMG__/zqrbLogo.png"/></span>
                ...
                <li class="menu">
                    <a href="<?php echo $vo['href']; ?>">
                        <i class="fa <?php echo $vo['icron']; ?>"></i>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a class="J_menuItem" href="<?php echo $v['href']; ?>"><?php echo $v['name']; ?></a>
                        </li>
