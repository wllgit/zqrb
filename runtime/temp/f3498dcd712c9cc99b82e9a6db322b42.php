<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"E:\demo\zqrb-server-php\public/../application/admin\view\wordblack\commentlist.html";i:1535952502;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <section class="panel">
                <div class="panel-body">
                    <div class="adv-table editable-table ">
                        <div class="clearfix">
                            <form role="form" id="comForm" action="/admin/wordblack/commentlist" method="get">
                            <div class="btn-group">
                                ...
                                <div class="col-lg-10 self_selct">
                                    <div class="self_topic_left">评论分类</div>
                                    <div class="self_topic_selct">
                                        <select  class="form-control slt" id="self_selct_id" onchange="window.location=this.value"  name="column_order">
                                            <option <?php if($column[0]==1): ?>selected<?php endif; ?> value="<?php echo url('admin/Wordblack/commentlist'); ?>?level=1">一级评论</option>
                                            <option <?php if($column[0]==2): ?>selected<?php endif; ?> value="<?php echo url('admin/Wordblack/commentlist'); ?>?level=2">二级评论</option>
                                        </select>
                                    </div>
                                </div>
                            </div>

                            <div style="width: 400px" role="form" class="form-inline pull-right">
                                <div class="content clearfix m-b" style="margin-top: 25px">
                                    <div class="form-group">
                                        <label style="float: left;margin-top: 5px">评论内容：</label>
                                        <input style="float: right" type="text" class="form-control" id="comment" name="comment">
                                    </div>
                            ...
                            <tr class="">
                                ...
                                <td class="custom_cls">
                                    <div class="pull-right hidden-phone">
                                        ...
                                        <?php if($vo['is_show'] == 1){ ?>
                                        <button onclick="is_show(this,'<?php echo $vo['id']; ?>',0,'<?php echo $vo['level']; ?>','<?php echo $vo['news_id']; ?>');" class="btn btn-danger btn-xs del"><a href="">隐藏</a></button>
                                        <?php }else{ ?>
                                        <button onclick="is_show(this,'<?php echo $vo['id']; ?>',1,'<?php echo $vo['level']; ?>','<?php echo $vo['news_id']; ?>');" class="btn btn-success btn-xs del"><a href="">通过</a></button>
                                        <?php } ?>
                                    </div>
                                </td>
                            </tr>
...
<script>
    ...
    function is_show(obj,id,type,level,news_id) {
        var data = {'id':id,'type':type,'level':level,'news_id':news_id};
        var url = '/admin/wordblack/isShow';
