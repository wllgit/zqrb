<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"E:\demo\zqrb-server-php\public/../application/admin\view\newsmanage\newsdraft.html";i:1535952502;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
                    ...
                    <div class="adv-table editable-table ">
                        <div class="clearfix">
                                ...
                                <div class="col-lg-10 self_selct">
                                    ...
                                    <div class="self_topic_selct">
                                        <select  class="form-control slt" id="self_selct_id" onchange="window.location=this.value"  name="column_order">
                                            <option <?php if($column[0]==0): ?>selected<?php endif; ?> value="<?php echo url('admin/Newsmanage/newsDraft'); ?>?name=0">全部</option>
                                            ...
                                            <option <?php if($column[0]==$vo[1]): ?>selected<?php endif; ?> value="<?php echo url('admin/Newsmanage/newsDraft'); ?>?name=<?php echo $vo[1]; ?>"><?php echo $vo[0]; ?></option>
                            ...
                            <div class="btn-group pull-right" style="margin-top:60px;">
                                <form role="form" id="comForm" action="/admin/Newsmanage/newsDraft" method="get">
                        ...
                        <table class="table table-striped table-hover table-bordered">
                            ...
                            <tr class="">
                                ...
                                <td><?php echo $vo['allow_ad']; ?></td>
                                <td class="center"><?php echo $vo['create_time']; ?></td>
                                <td class="center"><?php echo $vo['author']; ?></td>
                                <td><a class="edit" href="javascript:;"><?php echo $vo['name']; ?></a></td>
                                <td class="custom_cls">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(data.code == 1){
                        ...
                        setTimeout("javascript:location.href='./newsDraft'", 1000);
                    }else{
